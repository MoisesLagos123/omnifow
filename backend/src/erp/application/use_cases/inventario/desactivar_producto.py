"""Use Case: Desactivar Producto (soft)."""
...
class DesactivarProductoCommand:
    contexto: ContextoSeguridad
    producto_id: UUID


@dataclass(frozen=True)
class DesactivarProductoResult:
    id: UUID
    activo: bool
...
class DesactivarProductoUseCase:
    ...
    def execute(self, cmd: DesactivarProductoCommand) -> DesactivarProductoResult:
        ...
        with self._uow:
            ...
            self._uow.commit()
        return DesactivarProductoResult(id=producto.id, activo=False)
